...
#include "reduction_kernel.cu" // Include the reduction kernel
...
int main(int argc, char *argv[])
{
    ...
    unsigned int *device_min_hash_array, *device_min_nonce_array;
    ...
    unsigned int *min_hash_array = (unsigned int *)malloc(num_blocks * sizeof(unsigned int));
    unsigned int *min_nonce_array = (unsigned int *)malloc(num_blocks * sizeof(unsigned int));
